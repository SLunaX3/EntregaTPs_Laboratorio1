...
/** \brief  Obtiene un nodo de la lista (la direccion de memoria de un "bagón")
 *
 * \param this LinkedList* Puntero a la lista
...
static Node* getNode(LinkedList* this, int nodeIndex)
{
    ...
    {
        pNode = this->pFirstNode; //apunto al primer bagon
    ...
    if(this != NULL && nodeIndex >= 0 && nodeIndex <= ll_len(this))
    {
        ...
        if( pNode != NULL)
        {
            ...
            else
            {
                ...
                pNode->pNextNode = nodoAnt->pNextNode;
                nodoAnt->pNextNode = pNode;
            }
            this->size++;
            returnAux = 0;
        }
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index < ll_len(this))
    {
        nodoAux = getNode(this, index);// adonde apuntaba mi nodo q quiero eliminar
        if(index == 0)
        {
